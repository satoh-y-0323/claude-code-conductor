...
> `design-review-report-20260807-234743.md` が AC-36 の追記・AC-59 の旧版残留・AC-61 のリテラル 3 件欠落・
...
> （設計レポート改訂 28 `.claude/reports/architecture-report-20260808-005740.md` の裁定）:
>
> 1. **契約 `docs/refgraph-contract.md` §6 の完成条件（＋ §5-1 クエリ層の完成条件）**
> 2. **確定済みの実測基準**（既存辺の喪失 0・ルート外絶対パス断片 0・py 4 relation 不変・
>    A-3 判定材料 3 件が live。`.dev/handoff-20260806-refgraph-design.md` §1）
