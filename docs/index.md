...
- **Tier 自動ルーティング (tier-routing)**: タスク複雑度に応じた Haiku/Sonnet/Opus の動的選択（Thompson Sampling）。対象は developer / wt_developer と、v2.54.0 以降の tester / wt_tester（Red フェーズ限定・確認フェーズは対象外）
